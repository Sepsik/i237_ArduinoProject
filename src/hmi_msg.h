...
const char version_info[] PROGMEM = "Version: " FW_VERSION " built on: " __DATE__ " " __TIME__ "\n";
const char avr_info[] PROGMEM = "avr-libc version: " __AVR_LIBC_VERSION_STRING__ " avr-gcc version: " __VERSION__ "\n";
...
const char not_valid_input_msg[] PROGMEM = "Please enter number between 0 and 9!\n";
